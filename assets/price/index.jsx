...
const PriceOneTime=(props)=> <section className="first-section-container price-one-time-img" id="oneTime">
    ...
    <div className="button-row">
        <a href='/price#oneTime' className='button typo-button'>РАЗОВОЕ ПОСЕЩЕНИЕ</a>
        <a href='/price#subscriptions' className='button typo-button'>АБОНЕМЕНТЫ И БЕЗЛИМИТЫ</a>
        <a href='/price#miniGroups' className='button typo-button'>СТОИМОСТЬ ЗАНЯТИЙ В МИНИГРУППАХ</a>
        {/* <a href='/price' className='button typo-button'>ИНДИВИДУАЛЬНЫЕ ЗАНЯТИЯ</a> */}
        <a href='/price#rules' className='button typo-button'>ПРАВИЛА</a>
    </div>
...
const PriceList=props=> <section className="main-section-white-background" id="subscriptions">
    ...
    <div className="price-unlimited-container standart-margin">
...
const PriceRules=props=> <section className="main-section-white-background" id="rules">
    ...
    <div className="row-rules standart-margin">
        ...
        <div>
            <img src="/static/img/rules.jpg" alt='rules'/>
        </div>
    </div>
</section>
