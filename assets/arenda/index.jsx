...
const DanceHall=(props)=><section className="main-section-white-background"  id={props.id}>
...
const ArendaTitle=(props)=><section>
    <div className="arenda-title-img static-background-img"></div>
    <div className="title-section arenda-title-section-padding">
